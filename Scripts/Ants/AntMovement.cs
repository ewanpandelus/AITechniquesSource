...
public class AntMovement : MonoBehaviour
{
    ...
    private void EvaluateState()
    {
        switch (movementState)
        {
            case MovementState.RandomMovement:
                Movement(true);
                break;
            case MovementState.MovingTowardsResource:
                MoveTowardsResource();
                break;
            case MovementState.ReturningToQueen:
                ReturnToQueen();
                break;
    ...
    private Vector2 EvaluateBlockingPositions()
    {
        ...
        if (up && !left && !right)
        {
            if (movementState != MovementState.ReturningToQueen)
            {
    ...
    public void SetResourceToMoveTowards(GameObject _resource)
    {
        ...
        movementState = MovementState.MovingTowardsResource;
    ...
    public void SetMovementState(MovementState _movmementState)
    {
        movementState = _movmementState;
    }
